...
const stripe = require("stripe")(
  "sk_test_51Q6aoeRp3Yp8cr5Ka11NEmVLcUo7x62KPC4qfcwY0lUI9pRpFf9s1XIZGx6CyCenhFGoeRaiErYK22K6TvWQL3fO00tqG1PE6Z"
);
...
export async function createStripePaymentAction(data) {
  const session = await stripe.checkout.sessions.create({
    ...
    mode: "subscription",
    success_url: `${process.env.BASE_URL}/membership` + "?status=success",
    cancel_url: `${process.env.BASE_URL}/membership` + "?status=cancel",
  });
